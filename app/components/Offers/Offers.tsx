...
import { Card, Badge, CardBody, Button, CardFooter } from "@nextui-org/react";
  ...
  return (
    <Container className="flex flex-col gap-4 items-center">
      ...
      <Card className="flex w-full items-center p-4">
        <CardBody className="flex-col md:flex-row justify-between gap-4">
        ...
        <CardFooter className="justify-center">
          <Button color="success">לפרטים נוספים</Button>
        </CardFooter>
      </Card>
    </Container>
  );
